...
class RdsoproDrawerfields(models.Model):
    field_id = models.IntegerField(primary_key=True)
    field = models.CharField(max_length=100)
    field_link = models.CharField(max_length=200)
...
class RdsoproRoles(models.Model):
    ...
    class Meta:
        managed = False
        db_table = 'RDSOPro_roles'


class RdsoproUsers(models.Model):
    user_id = models.IntegerField(primary_key=True)
    user_name = models.CharField(max_length=100)
    role_id = models.ForeignKey(RdsoproRoles, models.DO_NOTHING, blank=True, null=True)
...
class CommEmpFamily(models.Model):
    idrow = models.AutoField(primary_key=True,unique=True)
